        ...
        <div className="p-4 space-y-3">
          ...
          <div className="flex items-start justify-between gap-2">
            <div className="flex items-center gap-2">
              <div className="p-2 rounded bg-cyan-100 dark:bg-cyan-800">
                <Zap className="w-6 h-6 text-cyan-600 dark:text-cyan-300" />
              </div>
              <span className="text-base font-semibold text-cyan-700 dark:text-cyan-300">
                Action Chip
              </span>
            </div>
            <ValidationIcon className={cn('w-6 h-6 flex-shrink-0', validationColor)} />
          </div>
